...
const ChartLine = createLucideIcon("chart-line", __iconNode$l);
const __iconNode$k = [
  [
    "path",
    {
...
const ChartPie = createLucideIcon("chart-pie", __iconNode$k);
...
const Earth = createLucideIcon("earth", __iconNode$g);
const __iconNode$f = [
...
const Newspaper = createLucideIcon("newspaper", __iconNode$8);
const __iconNode$7 = [
  [
    "path",
    {
...
const Sunrise = createLucideIcon("sunrise", __iconNode$2);
const __iconNode$1 = [
